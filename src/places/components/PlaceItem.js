...
const PlaceItem = props => {
    ...
    // Show the map when the button is clicked and close the map when button is clicked again
    ...
    return (
        <React.Fragment>
            ...
            >
                <p>Do you want to proceed and delete this palce? Please note that it can't be undone later.</p>
            </Modal>
